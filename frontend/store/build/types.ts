import type { EntityKind, EntityRates } from '../../utils/build/entityRates'
import type {
  AttributeKey,
  CustomStat,
  EquippedItem,
...
export interface BuildActions {
  ...
  incSkillRank: (skillId: string, maxRank: number, amount?: number) => void
  decSkillRank: (skillId: string, amount?: number) => void
